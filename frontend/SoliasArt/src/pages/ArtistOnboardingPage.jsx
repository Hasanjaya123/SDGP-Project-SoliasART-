...
export const ArtistOnboardingPage = ({ setCurrentPage }) => {
  ...
  const handleNext = () => {
    if (currentStep < 4) {
      ...
      setCurrentPage('artistOnboardingSuccess');
    }
  };
          ...
          return (
            <React.Fragment key={step.num}>
              <div className={`flex items-center gap-2 ${isCurrent || isCompleted ? 'text-[#FFC247]' : 'text-slate-400 dark:text-slate-500'}`}>
                ...
                <span className={`text-sm ${isCurrent || isCompleted ? 'font-bold' : 'font-medium'}`}>{step.label}</span>
              </div>
              ...
              <div className="flex flex-col gap-2">
                ...
                <div className="relative">
                  ...
                  <select 
                    ...
                    onChange={(e) => updateForm('primaryMedium', e.target.value)}
                  >
                  ...
                  {formData.artisticStyles.map(style => (
                    <div key={style} className="flex items-center gap-1 bg-slate-100 dark:bg-zinc-700 text-slate-700 dark:text-slate-200 px-3 py-1 rounded-full text-sm">
                      ...
                      <button 
                        ...
                        onClick={() => updateForm('artisticStyles', formData.artisticStyles.filter(s => s !== style))}
                      >
                    ...
                    onKeyDown={(e) => {
                      if (e.key === 'Enter' && e.currentTarget.value) {
                        ...
                        if (formData.artisticStyles.length < 3 && !formData.artisticStyles.includes(e.currentTarget.value)) {
                          updateForm('artisticStyles', [...formData.artisticStyles, e.currentTarget.value]);
                    ...
                    <button 
                      ...
                      onClick={() => {
                        if (formData.artisticStyles.length < 3 && !formData.artisticStyles.includes(style)) {
                          updateForm('artisticStyles', [...formData.artisticStyles, style]);
                        }
                      }}
                    >
                      {style}
              ...
              <div className="flex flex-col gap-2">
                ...
                <div className="relative">
                  ...
                  <input 
                    ...
                    onChange={(e) => updateForm('dispatchAddress', e.target.value)}
                  />
  ...
  const renderPreviewPanel = () => {
    const isPrivateStep = currentStep === 3 || currentStep === 4;
      ...
      <div className="hidden lg:flex lg:w-[50%] xl:w-[50%] bg-[#f8f8f6] dark:bg-black relative flex-col justify-start items-center p-0 border-l border-slate-200 dark:border-zinc-800 overflow-y-auto transition-colors duration-300">
        <div className="w-full relative flex flex-col gap-6 bg-white dark:bg-zinc-900 shadow-sm min-h-full transition-colors duration-300">
          ...
          <div className="px-8 pb-8 -mt-20 relative">
            ...
            <div className={`mt-4 ${isPrivateStep ? 'opacity-30 blur-sm' : ''} transition-all duration-500`}>
              ...
              {currentStep >= 2 && formData.artisticStyles.length > 0 && (
            ...
            <div className={`flex items-center gap-6 mt-8 border-t border-slate-100 dark:border-zinc-800 pt-6 pb-2 ${isPrivateStep ? 'opacity-30 blur-sm' : ''} transition-all duration-500`}>
            ...
            <div className={`mt-8 border-b border-slate-200 dark:border-zinc-800 ${isPrivateStep ? 'opacity-30 blur-sm' : ''} transition-all duration-500`}>
  ...
  const getStepTitle = () => {
    switch (currentStep) {
      case 1: return 'Artist Identity';
      case 2: return 'Artistic Style';
      case 3: return 'Commerce & Logistics';
      case 4: return 'Trust & Verification';
      default: return '';
    }
  };
  ...
  const getNextButtonText = () => {
    switch (currentStep) {
      case 1: return 'Next: Art Style';
      case 2: return 'Next: Commerce';
      case 3: return 'Next: Verification';
  ...
  return (
    <div className="bg-[#f8f8f6] dark:bg-black font-sans overflow-hidden h-screen flex flex-col text-slate-900 dark:text-white transition-colors duration-300">
      ...
      <main className="flex flex-1 overflow-hidden">
        <div className="w-full lg:w-[50%] xl:w-[50%] h-full overflow-y-auto bg-white dark:bg-zinc-900 flex flex-col relative z-10 transition-colors duration-300">
          <div className="px-6 pt-4 pb-2">
            <div className="flex flex-col gap-2">
              <div className="flex justify-between items-end">
                <h1 className="text-2xl font-bold text-slate-900 dark:text-white">{getStepTitle()}</h1>
                <span className="text-[#FFC247] font-bold text-sm">{currentStep * 25}% Completed</span>
              </div>
              <div className="h-2 w-full bg-slate-100 dark:bg-zinc-800 rounded-full overflow-hidden">
                <div className="h-full bg-[#FFC247] rounded-full transition-all duration-500" style={{ width: `${currentStep * 25}%` }}></div>
              </div>
              {renderStepIndicator()}
            </div>
          </div>
