...
const UploadArtPage = () => {
            ...
            return (
              <React.Fragment key={s.num}>
                <div className={`flex items-center gap-2 ${isCurrent ? 'text-amber-500' : isCompleted ? 'text-green-600 dark:text-green-400' : 'text-gray-400 dark:text-gray-600'}`}>
                  <span className={`flex items-center justify-center w-6 h-6 shrink-0 rounded-full text-xs font-bold border ${isCompleted ? 'bg-green-100 border-green-100 text-green-600 dark:bg-green-900/30 dark:border-green-800 dark:text-green-400' :
  ...
  const renderStepMedia = () => (
    <div className="flex flex-col gap-8 animate-fade-in-up">
      ...
      <div
        className={`group relative flex flex-col items-center justify-center w-full h-56 border-2 border-dashed rounded-xl transition-all cursor-pointer ${isDragOver
